...
-- TODAS as expectations aqui sao "warn" (nenhuma tem ON VIOLATION). 
-- A prata nao pode perder registro. As expectations
-- MEDEM a qualidade e publicam a metrica no event log; 
-- Quem decide excluir eh a gold, porque excluir eh decisao de negocio.
...
-- "view intermediaria com expectations", nada e materializado em UC,
-- so as metricas do contrato saem para o event log.

-- Numa expectation, NULL conta como REPROVADO. Por isso as
